...
Route::controller(CartController::class)->group(function () {
    ...
    Route::get('/delete-invalid-carts', 'deleteInvalidCarts')->name('carts.deleteInvalid');
});
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function() {
    ...
    Route::group(['prefix' => 'checkout'], function() {
        Route::controller(CheckoutController::class)->group(function () {
            ...
            Route::any('/payment_selects', 'store_delivery_info2')->name('checkout.store_delivery_info2');
            ...
            Route::post('/delivery_time_selected', 'delivery_time_selected')->name('checkout.delivery_time_selected');
...
Route::controller(CcavenueController::class)->group(function () {
    ...
    Route::any('/ccavenue/check-status', 'statusCheck')->name('ccavenue.statusCheck');
});
