...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(ReviewController::class)->group(function () {
        ...
        Route::post('/product_review_admin_modal', 'product_review_admin_modal')->name('product_review_admin_modal');
    });
...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    Route::controller(ZipcodeController::class)->group(function () {
        Route::get('/zipcode/list', 'index')->name('zipcode.index');
        Route::get('/zipcode/create', 'create')->name('zipcode.create');
        Route::post('/zipcode/insert', 'insert')->name('zipcode.insert');
        Route::get('/zipcode/edit/{id}', 'edit')->name('zipcode.edit');
        Route::post('/zipcode/update', 'update')->name('zipcode.update');
        Route::get('/zipcode/destroy/{id}', 'destroy')->name('zipcode.destroy'); //
    });
});