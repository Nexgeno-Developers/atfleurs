                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="CCAVENUE_MERCHANT_ID" value="{{  env('CCAVENUE_MERCHANT_ID') }}" placeholder="{{ translate('Paypal Client ID') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="CCAVENUE_CODE" value="{{  env('CCAVENUE_CODE') }}" placeholder="{{ translate('Paypal Client Secret') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="CCAVENUE_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Encryption Key')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="CCAVENUE_KEY" value="{{  env('CCAVENUE_KEY') }}" placeholder="{{ translate('Paypal Client Secret') }}" required>
                            </div>
                        </div>                        
                        <div class="form-group row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="ccavenue_sandbox" type="checkbox" @if (get_setting('ccavenue_sandbox') == 1)
                                        checked
                                    @endif>
