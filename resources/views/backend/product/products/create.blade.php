                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row d-none">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" value="kg" name="unit" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" required>
                            </div>
                        </div>
                        <div class="form-group row d-none">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <input type="text" class="form-control" value="" name="hsn_code" required>
                            </div>
                        </div>
                    </div>
                </div>  
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <select class="form-control aiz-selectpicker" name="gst" selected>
                                    ...
                                    <option value="12">{{translate('12%')}}</option>
                                    <option value="18">{{translate('18%')}}</option>
                                    <option value="28">{{translate('28%')}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
