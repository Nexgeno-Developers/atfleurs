...
@if($review == null)
    <form action="{{ route('reviews.store') }}" method="POST" >
        @csrf
        <input type="hidden" name="is_admin_review" value="1">
        <div class="modal-body">
            <div class="form-group row" id="products">
                <label class="col-md-3 col-from-label">{{translate('User')}} <span class="text-danger">*</span></label>
                <div class="col-md-8">
            ...
            <div class="form-group row" id="products">
                ...
                <div class="col-md-8">
                    <select multiple class="form-control aiz-selectpicker" name="product_id[]" id="product_id" data-live-search="true" required>
