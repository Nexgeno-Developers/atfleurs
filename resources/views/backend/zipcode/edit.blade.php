            ...
            <form class="form-horizontal" action="{{route('zipcode.update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" placeholder="{{ translate('Delivery Interval Time(hour)') }}" name="delivery_interval" class="form-control" value="{{ $zipcode->delivery_interval }}" required>
                        </div>
                    </div>
