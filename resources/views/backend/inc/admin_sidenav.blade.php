...
<!--zipcode quotation-->
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-map-pin aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Shipping Class')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{route('zipcode.create')}}">
                                <span class="aiz-side-nav-text">{{translate('Add New Shipping Class')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('zipcode.index')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('List All Shipping Class') }}</span>
                            </a>
                        </li>
                    </ul>
                    <!--Submenu-->
