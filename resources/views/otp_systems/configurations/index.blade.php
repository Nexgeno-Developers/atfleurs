...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{ translate('SMSGATEWAYHUB Credential') }}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        <input type="hidden" name="otp_method" value="msegat">
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="SMSGHUB_SENDER_2">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{ translate('SMSGHUB_SENDER_2') }}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="SMSGHUB_SENDER_2"
                                    value="{{ env('SMSGHUB_SENDER_2') }}" placeholder="SMSGHUB_SENDER_2" required>
                            </div>
                        </div>                        
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{ translate('Save') }}</button>
