                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="mt-3">
                                ...
                                @else
                                    <button type="button" class="btn btn-soft-primary mr-2 add-to-cart fw-600 gtagaddtocart" data-url="{{ url()->current() }}"
                                        onclick="addToCart()">
                                ...
                                <div class="row no-gutters mt-2 d">
                                    ...
                                    <div class=" mt-2">
                                        <a href="{{ route('returnpolicy') }}" target="_blank" class="d-none">
                                            ...
                                            @else
                                                <img src="{{ static_asset('assets/img/refund-sticker2.png') }}"
                                                    height="36">
                                            @endif
                                        </a>
                               ...
                               <div class="pb-0 pl-4 pr-4 pt-4">
                                ...
                                <div class="pb-5 pl-4 pr-4 pt-3">
                                    ...
                                    @if (count($detailedProduct->reviews) <= 0)
                                        <div class="text-left fs-14 opacity-70">
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="p-3">
                            <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="5"
                                data-lg-items="4" data-md-items="5" data-sm-items="2" data-xs-items="2"
