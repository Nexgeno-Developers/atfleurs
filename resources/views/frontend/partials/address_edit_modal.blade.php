<form class="form-default" role="form" action="{{ route('addresses.update', $address_data->id) }}" method="POST">
    ...
    <div class="p-3">
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3" id="address_person" name="address_person" placeholder="Address Person Name" value="{{ $address_data->address_person ?? '' }}" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input autocomplete="off" type="text" class="form-control mb-3" value="{{ $address_data->phone }}" name="phone" pattern="[1-9]{1}[0-9]{9}" minlength="10" maxlength="10" placeholder="Enter 10 digit phone number" title="Enter 10 digit phone number" required>
            </div>
        </div>
