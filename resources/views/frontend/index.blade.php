...
<section class="elegant_blooms_sec orange_light_bg">
     ...
     <div class="product_category shop_collection pt-xl-6 pt-lg-6 pt-md-6 pt-5 pb-5 ">
        <div class="container">
            <h4 class="heading_one heading_font1">Shop by Collection</h4>
            <p class="text-center balsamiq_font">-All Category of At Fluers -</p>
            <div class="row gutters-10 position-relative">
    ...
    <section class="reviews_section">
        <div class="container">
             ...
             <div class="mb-5 pt-2 text-center position_relative align-items-baseline">
                   <h3 class="h2 fw-700 mb-0 heading_font1">
                            <span class="border-bottom border-primary border-width-2 pb-2 d-inline-block">{{ translate('Testimonial') }}</span>
                        </h3>
...
<section class="texture_section pt-5">
		<div class="container">
			<div class="mb-5 pt-2 text-center position_relative align-items-baseline">
				<h3 class="h2 fw-700 mb-0 heading_font1">
					<span class="border-bottom border-primary border-width-2 pb-2 d-inline-block">{{ translate('What Our Customers Are Saying') }}</span>
				</h3>   
			</div>
