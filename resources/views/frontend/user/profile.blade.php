        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input autocomplete="off" type="text" class="form-control" name="phone" value="{{ Auth::user()->phone }}" pattern="[1-9]{1}[0-9]{9}" minlength="10" maxlength="10" placeholder="Enter 10 digit phone number" title="Enter 10 digit phone number" @if(!empty(Auth::user()->phone)) disabled @endif required>
                        @if(empty(Auth::user()->phone))
                        <span><small class="text-danger">Note : </small><small class="text-sm">Phone number cannot be changed once updated.</small></span>
                        @endif
                    </div>
                </div>
                
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">{{ translate('Your GST Number') }}</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" placeholder="{{ translate('Your GST Number')}}" name="gst_number" value="{{ Auth::user()->gst_number }}">
                    </div>
                </div>                 
