    ...
    public function product(Request $request, $slug)
    {
        ...
        if ($detailedProduct != null && $detailedProduct->published) {
            ...
            if ($detailedProduct->digital == 1) {
                return view('frontend.digital_product_details', compact('detailedProduct', 'product_queries', 'total_query', 'category_id1'));
            } else {
                return view('frontend.product_details', compact('detailedProduct', 'product_queries', 'total_query' , 'category_id1'));
            }
        }
        abort(404);
    }
...
*/
    ...
    public function variant_price(Request $request)
    {
        ...
        return array(
            ...
            'regular_price' => single_price($regular_price * $request->quantity),
            'discount_in_percentage' => round($Discount_percentage) ,
            'quantity' => $quantity,
