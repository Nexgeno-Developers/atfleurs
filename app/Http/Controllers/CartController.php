...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request)
    {
        ...
        if(auth()->user() != null) {
            ...
            $carts = Cart::where('user_id', $user_id)->get();
            // Call the model function to delete invalid carts
            Cart::deleteInvalidCarts($user_id);
        } else {
            if($request->session()->get('temp_user_id')) {
                $temp_user_id = $request->session()->get('temp_user_id');
            } else {
        ...
        if($product->auction_product == 0){
            ...
            // Calculate notify_date to be 1 hour from now
            $data['notify_date'] = Carbon::now()->addHour();
    ...
    public function deleteInvalidCarts()
    {
        // Call the model function to delete invalid carts
        Cart::deleteInvalidCarts();
        return response()->json([
            'message' => "Invalid carts deleted successfully."
        ]);
    }
}
